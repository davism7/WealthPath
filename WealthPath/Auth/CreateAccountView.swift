    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 32) {
                ...
                VStack(spacing: 14) {
                    AuthTextField(title: "Full Name", text: $fullName, icon: "person.fill")
                    AuthTextField(title: "Email", text: $email, icon: "envelope", keyboardType: .emailAddress)
